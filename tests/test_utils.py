...
class TestUtils(unittest.TestCase):
    def test_compatible_leagues(self):
        ...
        self.assertEqual(len(compatible_leagues(50000)), 1)
        self.assertIsInstance(compatible_leagues(50000)[0][0], str)
        self.assertIsInstance(compatible_leagues(50000)[0][1], int)
